...
**品質低下の事例**
- **Uplevel社調査**：Copilot使用グループでバグ41%増加（品質検証なしの場合）
- **GitClear社調査**：AIにコピペさせた結果 → コード重複8倍増加（2億行分析）
- **GitHub Copilot研究**：タスク完了26%増加の裏で、検証なしだと品質低下

**組織への悪影響**
- **Google DORA 2025**：レビューなしでAIコードをマージ → レビュー時間91%増、バグ9%増
- **2024年調査（600人以上）**：シニアエンジニアの65%がバーンアウトを経験
  - AIが生成した低品質コードの後始末が原因

**結論**：正しく使えば強力、間違えば逆効果（品質低下、負担増）
